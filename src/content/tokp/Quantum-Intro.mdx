...
<img src='/assets/blog/quantum-intro/blackbody.png' class='mx-auto max-w-52 max-h-52'/>
...
<img src='/assets/blog/quantum-intro/born.png' class='mx-auto'/>
...
While wavefunctions describe the state of a particle, observables are the properties that are measured.

We use operators to determine 

> <p class='text-xl'> **Basic properties of operators** </p>
> - Operators are represented in bra-ket notation as $\hat{A}$.
> - Operators will always have *real eigenvalues*, as they are hermitian; these eigenvalues correspond to measureable quantities.<br></br>
<p class='pt-1'>In other words, when we make a measurement, the result will correspond to an eigenvalue of the operator.</p>
